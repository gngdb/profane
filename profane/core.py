...
# %% auto 0
__all__ = ['RCDIR', 'parse_args', 'setup', 'get_config', 'create_dirs', 'SyncLocalCallback', 'SyncSharedCallback', 'init',
           'parse_output_log']
...
def init(**kwargs):
    ...
    local_hook = SyncLocalCallback(local_dir, wandb_dir)
    shared_hook = SyncSharedCallback(shared_dir, wandb_dir)
    ...
    # this will trigger on most other exits
    atexit.register(local_hook)
    atexit.register(shared_hook)
    return run
